...
from PyQt5.QtWidgets import QAction, QMenu, QMainWindow, QWidget, QVBoxLayout, QDialog, QFileDialog, QLabel

from notes import *
from notes.ui.Ui_MainWindow import Ui_MainWindow
from notes.ui.diag.find import Find
from notes.ui.diag.notebookfilterdialog import NotebookFilterDialog
from notes.ui.view.notebookfilteredwidget import NotebookFilteredTreeWidget
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def initActions(self):
        ...
        self.filterAction = QAction(QIcon("icons/filter.png"), "Filter notes", self)
        ...
        self.aboutAction = QAction("About Notes Manager", self)
        self.aboutAction.setStatusTip("Opens about box.")
    ...
    def onAbout(self):
        dlg = QDialog(self, Qt.WindowSystemMenuHint | Qt.WindowCloseButtonHint | Qt.WindowTitleHint)
        dlg.setWindowTitle("About Notes Manager")
        dlg.setFixedSize(300, 200)

        pic = QLabel(self)
        pic.setAlignment(Qt.AlignCenter)
        pixmap = QPixmap("Icon.png")
        pic.setPixmap(pixmap.scaled(QSize(64, 64), Qt.KeepAspectRatio, Qt.SmoothTransformation))
        ...
        name.setText("Notes Manager")

        version = QLabel(self)
        version.setAlignment(Qt.AlignCenter)
        version.setFont(QFont("Arial", 8, QFont.Normal))
        version.setText("Version 1.0.0")

        copyright = QLabel(self)
        copyright.setAlignment(Qt.AlignCenter)
        copyright.setText("Copyright © 2020 - Armen Matevosyan")
